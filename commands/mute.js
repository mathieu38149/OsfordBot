...
module.exports = {
    run: async (message, args) => {
        ...
        if (member.id === message.guild.ownerID) return message.channel.send('Tu ne peut pas mute ce membre.')
        ...
        if (!member.manageable) return message.channel.send('Je ne peut pas mute ce membre.')
